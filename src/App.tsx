...
const FEATURED_PROJECT = {
  ...
  problem:
    "Support agents were spending up to 40% of their working hours manually categorizing complex technical tickets, digging through logs, and drafting repetitive responses.",
  solution:
    "I designed and deployed an AI-driven Support Copilot using Make.com and Model Context Protocol (MCP). It autonomously ingests Zendesk conversation logs, analyzes API payloads, categorizes the root cause, and generates drafts for missing knowledge base entries.",
  impact: [
...
const OTHER_PROJECTS = [
  {
    ...
    problem:
      "High volume of 'integration broken' tickets with zero payload context from users.",
    solution:
      "Engineered a request-bin middleware that intercepts failing customer webhooks and provides an actionable error UI before a ticket is even created.",
    impact: [
  ...
  },
  {
    ...
    problem:
      "Disjointed metrics across Jira, Zendesk, and PagerDuty causing reactive rather than proactive incident response.",
    solution:
      "Built a unified dashboard pulling real-time SLA and bug-tracker metrics via REST APIs.",
    impact: [
...
const SERVICES = [
  {
    ...
    description:
      "I dive deep into application logs, write custom SQL queries, and reproduce complex edge-cases before they hit the core engineering team.",
  ...
  },
  {
    ...
    description:
      "I diagnose auth failures, rate limiting mismatches, and malformed JSON payloads across distributed SaaS infrastructure.",
  ...
  },
  {
    ...
    description:
      "I design and implement automation systems that connect disjointed tools via Zapier, Make.com, or custom Node.js middleware to eliminate manual data entry in workflows.",
...
export default function App() {
  return (
    <div className="min-h-screen bg-zinc-50 text-zinc-900 font-sans selection:bg-blue-200 selection:text-blue-900">
      ...
      <section className="pt-48 pb-32 px-6 lg:px-8 max-w-5xl mx-auto">
        ...
        >
          ...
          <h1 className="text-5xl sm:text-6xl font-bold tracking-tight text-zinc-900 leading-[1.1] mb-6">
            I turn complex API failures and support chaos into scalable AI
            systems that save teams time and money.
          </h1>
          <p className="text-lg sm:text-xl text-zinc-600 leading-relaxed max-w-2xl mb-10">
            I help SaaS teams resolve API issues faster, reduce escalations, and
            build automation that cuts support workload.
          </p>
      ...
      <Section
        id="projects"
        className="bg-zinc-50 border-y border-zinc-200 relative overflow-hidden"
      >
        ...
        <div className="mb-12 relative z-10">
          ...
          <p className="text-zinc-500 text-lg">
            Built from real-world support experience across SaaS environments.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start relative z-10">
          <div>
            ...
            <div className="space-y-8">
              <div>
                <h4 className="text-sm font-bold uppercase tracking-wider text-zinc-900 mb-2">
                  The Problem
                </h4>
              ...
              <div>
                ...
                <p className="text-zinc-600 leading-relaxed mb-3">
                  This transforms support from a reactive function into a
                  scalable, knowledge-driven system.
                </p>
          ...
          <div className="bg-white rounded-2xl p-8 border border-zinc-200 h-full shadow-sm">
            <div className="mb-8 border-b border-zinc-100 pb-6">
              <span className="text-xs font-bold uppercase tracking-wider text-zinc-400 mb-3 block">
              ...
              <div className="flex flex-wrap gap-2">
                {FEATURED_PROJECT.stack.map((tech) => (
                  <span
                    key={tech}
                    className="px-3 py-1.5 bg-zinc-50 border border-zinc-200 rounded-md text-sm font-mono text-zinc-700 shadow-sm transition-colors hover:border-zinc-300 pointer-events-none"
                  >
                    {tech}
                  </span>
                ))}
    ...
    "insights_generated": true
        ...
        <div className="mt-16 bg-white border border-zinc-200 shadow-sm rounded-2xl p-8 max-w-2xl text-center relative z-10 sm:p-10 mx-auto">
          ...
          <p className="text-zinc-600 mb-8 max-w-md mx-auto">
            I can walk you through the system and how it applies to your support
            workflow.
          </p>
          <a
            href="#contact"
            className="inline-flex items-center justify-center gap-2 bg-blue-600 text-white px-8 py-3 rounded-xl font-medium hover:bg-blue-700 transition-all focus:ring-4 focus:ring-blue-100 shadow-sm"
          >
          ...
          {OTHER_PROJECTS.map((project, index) => (
            ...
            >
              ...
              <div className="space-y-4 mb-8 text-sm flex-grow">
                <p>
                  <strong className="text-zinc-900 font-semibold text-xs uppercase tracking-wide block mb-1">
                    Problem:
                  </strong>{" "}
                  <span className="text-zinc-600">{project.problem}</span>
                </p>
                <p>
                  <strong className="text-zinc-900 font-semibold text-xs uppercase tracking-wide block mb-1">
                    Solution:
                  </strong>{" "}
                  <span className="text-zinc-600">{project.solution}</span>
                </p>
                <div>
                  <strong className="text-zinc-900 font-semibold text-xs uppercase tracking-wide flex items-center gap-1 mb-2 mt-4 text-blue-700">
                    🚀 Impact:
                  </strong>
              ...
              <div className="flex flex-wrap gap-2 mt-auto pt-6 border-t border-zinc-200">
                {project.stack.map((tech) => (
                  <span
                    key={tech}
                    className="text-xs font-mono bg-white border border-zinc-200 text-zinc-600 px-2.5 py-1 rounded shadow-sm"
                  >
                    {tech}
                  </span>
                ))}
      ...
      <Section className="bg-zinc-900 text-white border-y border-zinc-800">
        <div className="mb-16">
          ...
          <p className="text-zinc-400 max-w-2xl text-lg">
            My approach to troubleshooting complex SaaS environments isn't just
            about closing tickets; it's about solving the systemic root cause.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-10 lg:gap-12">
          {METHODOLOGY.map((item, index) => (
            <div key={index} className="group">
              ...
              <p className="text-zinc-400 leading-relaxed mb-4">{item.what}</p>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 text-left">
            <div className="p-6 bg-zinc-50 rounded-xl border border-zinc-100">
              ...
              <p className="text-sm text-zinc-600">
                Complex API issues are debugged at the root level, skipping Tier
                1 back-and-forth.
              </p>
            </div>
            <div className="p-6 bg-zinc-50 rounded-xl border border-zinc-100">
              ...
              <p className="text-sm text-zinc-600">
                Engineers get to focus on building product, not investigating
            ...
            <div className="p-6 bg-zinc-50 rounded-xl border border-zinc-100">
              ...
              <p className="text-sm text-zinc-600">
                Redundant triage, data entry, and info-gathering are replaced
            ...
            <div className="p-6 bg-zinc-50 rounded-xl border border-zinc-100">
              ...
              <p className="text-sm text-zinc-600">
                Every solved ticket feeds into an auto-updating internal matrix
                that empowers the entire team.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-16 lg:gap-24 items-center">
          <div>
            ...
            <div className="space-y-4 text-zinc-600 leading-relaxed text-lg">
              <p>
                My career started on the frontlines of customer support. I saw
                firsthand how a lack of structural triage between support and
                engineering tanked customer satisfaction.
              </p>
              <p>
                Over the last 8 years, I evolved into a systems builder. I speak
                the language of highly technical engineers (SQL, API logs,
                backend architecture) and translate it into clear integrations
                and automated workflows.
              </p>
              <div className="pl-4 border-l-4 border-blue-500 mt-6 pt-1 pb-1">
                <p className="font-semibold text-zinc-900 py-1">
                  I don’t just support systems. I build systems that support
                  teams.
                </p>
              </div>
            </div>
          ...
          <div
            id="contact"
            className="bg-white p-10 rounded-2xl border border-zinc-200 shadow-xl shadow-black/5 relative overflow-hidden"
          >
            ...
            <h3 className="text-2xl font-bold mb-3 relative z-10">
              Let's Build Better Support Systems
            </h3>
            <p className="text-zinc-600 mb-8 max-w-sm relative z-10">
              If your team is dealing with repeated issues, slow resolution
              times, or manual workflows—let’s fix that.
            </p>
