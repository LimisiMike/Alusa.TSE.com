  ...
  return (
    <section id="resume" className="max-w-7xl mx-auto px-6 w-full pt-8 pb-16">
      <div className="bg-[#111827] border border-[#1F2937] rounded-[2rem] p-8 md:p-12 shadow-2xl relative overflow-hidden">
        ...
        <h2 className="text-3xl font-bold tracking-tight text-white mb-8 relative z-10">Experience Snapshot</h2>
          ...
          >
            ...
            >
              <div className="bg-[#111827] text-[#94A3B8] p-4 text-center border-b border-[#374151] flex justify-between items-center px-6">
                ...
                <a href="/resume.pdf" target="_blank" rel="noopener noreferrer" className="text-[#5B8CFF] hover:text-[#8B5CF6] transition-colors flex items-center gap-2 text-sm font-bold">
                  Open in New Tab
                </a>
              </div>
              <object 
              ...
              >
                <div className="flex flex-col items-center justify-center h-full text-center p-8 bg-[#090B10] text-[#94A3B8]">
                  ...
                  <p className="mb-4 text-lg">Your browser might not support displaying PDFs within this preview.</p>
                  <a href="/resume.pdf" target="_blank" rel="noopener noreferrer" className="px-6 py-3 bg-[#5B8CFF] text-white rounded-xl hover:bg-[#8B5CF6] transition-colors font-medium">
                    Download / View PDF
                  </a>
                </div>
              </object>
